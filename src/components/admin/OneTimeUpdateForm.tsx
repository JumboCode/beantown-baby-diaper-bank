...
export default function OneTimeUpdateForm({ initialCityPercentages }: OneTimeUpdateFormProps) {
    ...
    <Paper withBorder radius="lg" p="lg">
      <Stack gap="md">
        ...
        <Text size="sm" c="dimmed">
          This will only update distributions for the selected month. It will not affect the
          partner&apos;s ongoing percentages or other months.
        </Text>
