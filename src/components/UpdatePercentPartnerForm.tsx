...
export default function UpdatePercentPartnerForm({
  ...
  const handleAddCity = () => {
    if (selectedPartnerId === null || !newCityId || newCityPercentage === "") {
      return;
    }
    ...
    setNewPercentages((prev) => [
      ...prev,
      {
        partnerId: BigInt(selectedPartnerId),
        cityId: BigInt(cityIdNum),
        percentage: db,
      } as PartnerRegion,
    ]);
        ...
        <Group style={{ marginLeft: "50%" }}>
          ...
          <Paper
            ...
            style={{
              ...
              backgroundColor:
                updateType === "continuous" ? "#E7F5FF" : "white",
            }}
            ...
            <Stack
              ...
              <Text
                ...
                c="dimmed"
                ta="center">
                Apply to all future distributions
              </Text>
            </Stack>
          </Paper>
        </Group>
