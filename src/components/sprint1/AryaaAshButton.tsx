...
// specifies the type for the prop, helpful when multiple props are passed in
interface props {
  label: string;
}

// should take a single prop 'label' and render a button with that label
function AryaaAshButton({ label }: props) {
  ...
  return (
    <div className="text-2xl flex flex-col items-center justify-center bg-[#EECDCC] h-screen space-y-5">
      ...
      <div className=" flex justify-center items-center">
        {age ? (
          <p>Your true age is {age ? age : "unknown"}, you liar!</p>
        ) : (
