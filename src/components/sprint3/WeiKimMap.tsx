...
import LeafletMap from "./WeiKimLeafletMap";
...
> = {
  ...
  cambridge: {
    ChildrenServed: 450,
    diapersDelivered: 52800,
    partnerSites: 15,
    fulfillmentRate: 0.94,
  },
  medford: {
    ChildrenServed: 175,
    diapersDelivered: 18500,
    partnerSites: 5,
    fulfillmentRate: 0.73,
  },
  somerville: {
    ChildrenServed: 390,
    diapersDelivered: 35200,
    partnerSites: 13,
...
const diaperLegendBuckets: LegendBucket[] = [
  ...
  { min: 20000, max: 39999, color: " #FAB532", label: "20k – 40k diapers" },
  { min: 40000, max: Infinity, color: " #A81C00 ", label: "40k+ diapers" },
];
...
export default function HanahCaitlynMap() {
