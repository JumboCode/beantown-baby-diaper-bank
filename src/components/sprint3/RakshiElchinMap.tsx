...
import LeafletMap from "@/components/sprint3/RakshiElchinLeafletMap";
...
export default function RakshiElchinMap() {
  ...
  const details = selectedRegionId
    ? regionDetails[selectedRegionId]
    : undefined;
        ...
        <LeafletMap
          ...
          points={{
            ...
            features: [
              ...
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.091, 42.362] },
                properties: {
                  id: "west-end",
                  name: "West End",
                  diapersDistributed: 8000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.12, 42.373] },
                properties: {
                  id: "cambridge-edge",
                  name: "Cambridge Edge",
                  diapersDistributed: 1500,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.14, 42.39] },
                properties: {
                  id: "somerville-east",
                  name: "Somerville East",
                  diapersDistributed: 3000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.067, 42.377] },
                properties: {
                  id: "charles-river",
                  name: "Charles River",
                  diapersDistributed: 450,
                },
              },
              ...
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.06, 42.347] },
                properties: {
                  id: "south-boston",
                  name: "South Boston",
                  diapersDistributed: 23000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.05, 42.375] },
                properties: {
                  id: "north-end",
                  name: "North End",
                  diapersDistributed: 12000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.09, 42.345] },
                properties: {
                  id: "dorchester",
                  name: "Dorchester",
                  diapersDistributed: 15000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.115, 42.353] },
                properties: {
                  id: "allston",
                  name: "Allston",
                  diapersDistributed: 42000,
                },
              },
              ...
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.01, 42.373] },
                properties: {
                  id: "quincy",
                  name: "Quincy",
                  diapersDistributed: 75000,
                },
              },
              {
                type: "Feature",
                geometry: { type: "Point", coordinates: [-71.15, 42.28] },
                properties: {
                  id: "braintree",
                  name: "Braintree",
                  diapersDistributed: 65000,
                },
              },
            ...
            <div>
              ...
              {impact && (
                <ul>
                  ...
                  <li>
                    Fulfillment rate: {Math.round(impact.fulfillmentRate * 100)}
                    %
                  </li>
                </ul>
              )}
