...
const cities = [
  ...
  {
    name: "Somerville",
    coords: [42.3876, -71.0995],
    startYear: 2014,
    startPopulation: 35,
  },
  {
    name: "Medford",
    coords: [42.4184, -71.1062],
    startYear: 2016,
    startPopulation: 5,
  },
  {
    name: "Arlington",
    coords: [42.4154, -71.1565],
    startYear: 2018,
    startPopulation: 60,
  },
  {
    name: "Brookline",
    coords: [42.3317, -71.1211],
    startYear: 2020,
    startPopulation: 20,
  },
  {
    name: "Quincy",
    coords: [42.2529, -71.0023],
    startYear: 2022,
    startPopulation: 15,
  },
];
  ...
  useEffect(() => {
    ...
    cityData.forEach((city) => {
      const justHitMilestone =
        city.impact >= MILESTONE && !celebratingCities.has(city.name);
      const justLostMilestone =
        city.impact < MILESTONE && celebratingCities.has(city.name);
        ...
        <div className="absolute top-4 right-4 bg-white p-3 rounded-lg shadow-lg z-[1000] max-w-xs">
          ...
          <div className="border-t pt-2 mt-2">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, hsl(200, 100%, 85%), hsl(200, 82%, 33%))",
              }}
            />
