      ...
      >
        <Tabs.List>
          <Tabs.Tab 
            ...
            leftSection=
              {activeTab === 'Partners' ? 
                <Image src='/admin_view/partners_tab_blue.svg' alt="partners active icon" height={16} width={16} /> 
                : 
                <Image src='/admin_view/partners_tab_gray.svg' alt="partners inactive icon" height={16} width={16}/>
              }
          >
            Partners 
          </Tabs.Tab>
          <Tabs.Tab 
            value="Diapers"
            leftSection= { activeTab === 'Diapers' ? 
              <Image src='/admin_view/diapers_tab_blue.svg' alt="partners active icon" height={16} width={16} /> 
              : 
              <Image src='/admin_view/Diapers_tab_gray.svg' alt="partners inactive icon" height={16} width={16}/>
            }
          > 
            Diapers 
          </Tabs.Tab>
        ...
        <Tabs.Panel value="Diapers">
          <h2>The diapers table is coming 😎</h2>
        </Tabs.Panel>
      </Tabs>
    </Stack>
  );
