...
export default function UploadNewData({ opened, onClose }: UploadNewDataProps) {
  ...
  return (
    <>
      <Modal opened={opened} onClose={onClose} size="lg" title={<Text fw={700} size="xl">Upload New Dataset</Text>}>
		<Stack gap="sm">
		...
		<Group justify="flex-end" gap="xs">
		    <Button variant="default" color="#163663" onClick={onClose}>Cancel</Button>
			<Button variant="filled" color="#163663" onClick={onClose}>Upload</Button>
		</Group>
		</Stack>
      </Modal>
