...
export default function PartnerMap() {
  ...
  if (loading) return <Center h={600}><Loader color="#51A3CC" size="xl" /></Center>;

  return (
    <Stack gap="md" m="xl">
      <Box>
        <Title order={2} c="#053766" fw={700}>Partner Locations</Title>
        <Text size="sm" c="dimmed">Distribution of partners matching original heatmap style</Text>
      </Box>

      <Paper withBorder radius="md" p={0} style={{ overflow: "hidden", height: "600px", zIndex: 0 }}>
