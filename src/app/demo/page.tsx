  ...
  return (
    <Container size="lg" py="xl">
      <Stack gap="xl">
        ...
        <Divider label="Why Mantine?" labelPosition="center" />

        <SimpleGrid cols={{ base: 1, sm: 2, lg: 3 }} spacing="lg" pb="sm">
              ...
              <Stack gap="xs">
                ...
                <Group gap="xs">
                  {card.badges.map((badge) => (
                    <Badge key={badge} color="teal" variant="light">
                      {badge}
                    </Badge>
                  ))}
                </Group>
        ...
        <Paper radius="md" p="lg" withBorder>
          <Stack gap="md">
            ...
            <Progress value={72} color="teal" size="lg" radius="xl" />
        ...
        <Paper radius="md" p="lg" shadow="sm" withBorder>
          <Stack gap="lg">
        ...
        <Paper radius="md" p="lg" withBorder>
          <Stack gap="md">
            ...
            <Stack gap="sm">
              {team.map((member) => (
                <Group key={member.name} justify="space-between" gap="md">
                  <Group gap="sm">
                    <Avatar color={member.color} radius="xl">
                      {member.name[0]}
                    </Avatar>
                    <Box>
                  ...
                  <Badge color={member.color} variant="outline">
